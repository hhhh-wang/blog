...
http 发送 get 请求 如 [https://127.0.0.1:8080/getEnc?username=kuizuo&password=a123456](https://127.0.0.1:8080/getEnc?username=kuizuo&password=a123456)，即可得到 enc 调用后的结果，post 请求同理
