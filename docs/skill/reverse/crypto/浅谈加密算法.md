...
3. Base64 的应用
   ...
   例如下面这些数据 通过链接 [base64 图片在线转化](https://tool.chinaz.com/tools/imgtobase/)即可 base64 编码数据与图片互相转化
...
公钥和密钥是不能乱写的，需要通过工具生成密钥对 [在线链接](https://web.chacuo.net/netrsakeypair) 如下例
