...
const TITLE = '友链'
const DESCRIPTION = '良师益友如宝贵财富，彼此成就，方能走得更远。'
const ADD_FRIEND_URL = 'https://github.com/hhhh-wang/blog/edit/main/data/friends.tsx'
const SITE_INFO = `
title: '变量人生'
description: '无论前路如何，探索与学习是我不断进化的动力'
website: 'https://bianliangrensheng.cn'
avatar: 'https://bianliangrensheng.cn/img/logo.png'
`
